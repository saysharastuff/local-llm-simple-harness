export const REVIEW_LENSES = [
  ...
  },
  {
    id: "async",
    description:
      "Async control flow, promises, cancellation, races, and cleanup",
    exemplars: [
  ...
  },
  {
    id: "reliability",
    description:
      "Error handling, timeouts, bounded retries, and failure recovery",
    exemplars: [
  ...
  },
  {
    id: "security",
    description:
      "Unsafe input, injection, secrets, path escape, and trust boundaries",
    exemplars: [
      "Review security",
