...
const GUIDANCE = {
  correctness: "logic correctness, edge cases, and demonstrated behavioral bugs",
  async: "asynchronous control flow, cancellation, promises, races, and cleanup",
  reliability: "error propagation, timeouts, bounded resources, and failure recovery",
  security: "trust boundaries, untrusted input, injection, secrets, and unsafe assumptions",
  performance: "avoidable work, memory growth, latency, and scalability risks",
  maintainability: "clarity, coupling, duplication, and change-sensitive design",
};
